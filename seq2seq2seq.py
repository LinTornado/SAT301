...
class seq2seq2seq():
    ...
    def train(self):
        ...
        print(f"model dir:{gen_model_dir}")
    ...
    def test(self):
        ...
        #
        #     # If the generated summary is empty, skip this loop
        #     if not gen_summ:
        #         continue
        #
        ...
        # print(gen_summaries[1])

        # bert_score.score(['hello'], ['how do you do'], lang='en', verbose=True)
        # Calculate the average BertScore metric for all reference summary and generated summary
        # avg_P = sum(P) / len(P)
        # avg_R = sum(R) / len(R)
        # avg_F1 = sum(F1) / len(F1)
        #
        # print("Average BertScore Indicator：Precision={:.2f}, Recall={:.2f}, F1={:.2f}".format(avg_P, avg_R, avg_F1))
