...
def parse():
    ...
    parser.add_argument('-source_length',default=500,type=int,help='source sentence length 50')
    parser.add_argument('-code_length',default=20,type=int,help='code sentence length 13')
    ...
    parser.add_argument('-test_input', default='CNN-DailyMail News/test/article.txt',help='path of testing input')
